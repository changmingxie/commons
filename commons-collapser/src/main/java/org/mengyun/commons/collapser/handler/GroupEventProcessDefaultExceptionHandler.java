 ...
 */
public class GroupEventProcessDefaultExceptionHandler implements ExceptionHandler<GroupEvent> {

    static final Logger logger = LoggerFactory.getLogger(GroupEventProcessDefaultExceptionHandler.class);

    @Override
    public void handleEventException(Throwable throwable, long sequence, GroupEvent event) {
